  ...
  products: [
    {
      ...
      image: '/images/natto/natto_01.png',
      gallery: [
        '/images/natto/natto_01.png',
        '/images/natto/natto_02.png',
        '/images/natto/natto_03.png',
        '/images/natto/natto_04.png',
        '/images/natto/natto_05.png',
      ],
      benefits: [
    ...
    },
    {
      ...
      subscriptionDiscount: 17,
      image: '/images/bpc/bpc_front_bottle.webp',
      gallery: [
        '/images/bpc/bpc_front_bottle.webp',
        '/images/bpc/bpc_hand_holding_bottle.webp',
        '/images/bpc/bpc_capsule_hero.webp',
        '/images/bpc/bpc_capsule_fingers.webp',
        '/images/bpc/bpc_back_label.webp',
        '/images/bpc/bpc_morning_setting.webp',
        '/images/bpc/bpc_amino_acids.webp',
      ],
      benefits: [
